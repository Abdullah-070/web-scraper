...
must subclass BaseScraper. This is what lets the queue
worker call any scraper identically and what satisfies the modularity principle.
"""
...
class BaseScraper(ABC):
    ...
    def validate_input(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        Should return the cleaned params dict to use.
        """
